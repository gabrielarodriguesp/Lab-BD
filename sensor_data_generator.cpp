...
void generate_sensor_data(int thread_id, int num_entries, const std::string& filename) {
    ...
    std::uniform_int_distribution<int> deviceId_distribution(0, 999);
    ...
    for (int i = 0; i < num_entries; ++i) {
        std::string deviceId = "sensor_" + std::to_string(deviceId_distribution(generator));
